...
generateIt(omim2zfin, ont, reasoner, "OMIM_", "ZDB-")
generateIt(omim2mgi, ont, reasoner, "OMIM_", "MGI_")
generateIt(mgi2omim, ont, reasoner, "MGI_", "OMIM_")
generateIt(zfin2omim, ont, reasoner, "ZDB-", "OMIM_")

generateIt(mgi2hp, ont, reasoner, "MGI_", "HP_")
generateIt(mgi2mp, ont, reasoner, "MGI_", "MP_")
generateIt(mgi2wp, ont, reasoner, "MGI_", "WBPhenotype_")
generateIt(mgi2yp, ont, reasoner, "MGI_", "APO_")
generateIt(mgi2fp, ont, reasoner, "MGI_", "FBcv_")
...
generateIt(omim2hp, ont, reasoner, "OMIM_", "HP_")
generateIt(omim2mp, ont, reasoner, "OMIM_", "MP_")
generateIt(omim2wp, ont, reasoner, "OMIM_", "WBPhenotype_")
generateIt(omim2yp, ont, reasoner, "OMIM_", "APO_")
generateIt(omim2fp, ont, reasoner, "OMIM_", "FBcv_")

generateIt(worm2hp, ont, reasoner, "WBGene", "HP_")
generateIt(worm2mp, ont, reasoner, "WBGene", "MP_")
generateIt(worm2yp, ont, reasoner, "WBGene", "APO_")
generateIt(worm2wp, ont, reasoner, "WBGene", "WBPhenotype_")
generateIt(worm2fp, ont, reasoner, "WBGene", "FBcv_")
