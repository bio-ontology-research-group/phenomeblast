...
def baselineout = new PrintWriter(new BufferedWriter(new FileWriter(new File("eval/baselinedisease.txt"))))
def baselineoutother = new PrintWriter(new BufferedWriter(new FileWriter(new File("eval/baselineother.txt"))))
